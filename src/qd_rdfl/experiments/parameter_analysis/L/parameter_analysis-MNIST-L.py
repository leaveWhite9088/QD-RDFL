...
if __name__ == "__main__":
    ...
    UtilsMNIST.print_and_log(global_minst_parent_path, "最终的 adjustment_literation_list 列表：")
    UtilsMNIST.print_and_log(global_minst_parent_path, f"adjustment_literation_list: {adjustment_literation_list}")