...
if __name__ == "__main__":
    ...
    for n in [9,19,29,39,49,59]:
        ...
        while True:
            ...
            # 提前中止
            if literation > adjustment_literation:
                UtilsCIFAR10.print_and_log(global_cifar10_parent_path, f"U_Eta_list_RANDOM: {U_Eta_list_RANDOM}")
                UtilsCIFAR10.print_and_log(global_cifar10_parent_path, f"U_qn_list_RANDOM: {U_qn_list_RANDOM}")
                break
        ...
        while True:
            ...
            # 提前中止
            if literation > adjustment_literation:
                UtilsCIFAR10.print_and_log(global_cifar10_parent_path, f"U_Eta_list_FIX: {U_Eta_list_FIX}")
                UtilsCIFAR10.print_and_log(global_cifar10_parent_path, f"U_qn_list_FIX: {U_qn_list_FIX}")
                break
    ...
    UtilsCIFAR10.print_and_log(global_cifar10_parent_path, "QD-RDFL最终的列表：")
    UtilsCIFAR10.print_and_log(global_cifar10_parent_path, f"U_Eta_list: {U_Eta_list}")
    UtilsCIFAR10.print_and_log(global_cifar10_parent_path, f"U_qn_list: {U_qn_list}")
    UtilsCIFAR10.print_and_log(global_cifar10_parent_path, "RANDOM最终的列表：")
    UtilsCIFAR10.print_and_log(global_cifar10_parent_path, f"U_Eta_list_RANDOM: {U_Eta_list_RANDOM}")
    UtilsCIFAR10.print_and_log(global_cifar10_parent_path, f"U_qn_list_RANDOM: {U_qn_list_RANDOM}")
    UtilsCIFAR10.print_and_log(global_cifar10_parent_path, "FIX最终的列表：")
    UtilsCIFAR10.print_and_log(global_cifar10_parent_path, f"U_Eta_list_FIX: {U_Eta_list_FIX}")
    UtilsCIFAR10.print_and_log(global_cifar10_parent_path, f"U_qn_list_FIX: {U_qn_list_FIX}")
