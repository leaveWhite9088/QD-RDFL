...
def ready_for_task(Lambda, Rho, Alpha, Epsilon, N, M, SigmaM, data_dir):
    ...
    # 切分数据
    UtilsCIFAR100.split_data_to_dataowners_evenly(dataowners, train_data, train_labels)
...
if __name__ == "__main__":
    ...
    for n in [59]:
        ...
        while True:
            ...
            # 提前中止
            if literation > adjustment_literation:
                UtilsCIFAR100.print_and_log(global_cifar100_parent_path, f"U_Eta_list_RANDOM: {U_Eta_list_RANDOM}")
                UtilsCIFAR100.print_and_log(global_cifar100_parent_path, f"U_qn_list_RANDOM: {U_qn_list_RANDOM}")
                break
        ...
        while True:
            ...
            # 提前中止
            if literation > adjustment_literation:
                UtilsCIFAR100.print_and_log(global_cifar100_parent_path, f"U_Eta_list_FIX: {U_Eta_list_FIX}")
                UtilsCIFAR100.print_and_log(global_cifar100_parent_path, f"U_qn_list_FIX: {U_qn_list_FIX}")
                break
    ...
    UtilsCIFAR100.print_and_log(global_cifar100_parent_path, "QD-RDFL最终的列表：")
    UtilsCIFAR100.print_and_log(global_cifar100_parent_path, f"U_Eta_list: {U_Eta_list}")
    UtilsCIFAR100.print_and_log(global_cifar100_parent_path, f"U_qn_list: {U_qn_list}")
    UtilsCIFAR100.print_and_log(global_cifar100_parent_path, "RANDOM最终的列表：")
    UtilsCIFAR100.print_and_log(global_cifar100_parent_path, f"U_Eta_list_RANDOM: {U_Eta_list_RANDOM}")
    UtilsCIFAR100.print_and_log(global_cifar100_parent_path, f"U_qn_list_RANDOM: {U_qn_list_RANDOM}")
    UtilsCIFAR100.print_and_log(global_cifar100_parent_path, "FIX最终的列表：")
    UtilsCIFAR100.print_and_log(global_cifar100_parent_path, f"U_Eta_list_FIX: {U_Eta_list_FIX}")
    UtilsCIFAR100.print_and_log(global_cifar100_parent_path, f"U_qn_list_FIX: {U_qn_list_FIX}")
