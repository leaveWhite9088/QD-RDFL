...
# 假设这是您的算法和对比算法的精度数据
# 精度值
accuracy_your_algorithm = [0.6871, 0.7721, 0.7721, 0.7868, 0.7868, 0.7868, 0.7868, 0.7868, 0.7868, 0.7868, 0.7868, 0.7868, 0.7868,
...
accuracy_comparison_algorithm = [0.5132, 0.6429, 0.7586, 0.7755, 0.7859, 0.7882, 0.7882, 0.7882, 0.7882, 0.7882, 0.7992, 0.7992,
